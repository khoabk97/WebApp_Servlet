...
public class MyUtils {
	...
	public static void storeLoginedUser(HttpSession session, UserAccount loginedUser) {
		// Trên JSP có thể truy cập thông qua ${loginedUser} - JSTL
	...
	public static void storeUserCookie (HttpServletResponse response, UserAccount user ) {
		//Check: System.out.println("Store user cookie");
		Cookie cookieUserName = new Cookie(ATT_NAME_USER_NAME, user.getUserName());
		// 1 ngày (Đã đổi ra giây), là thời gian sống của cookie đã lưu
		cookieUserName.setMaxAge(24*60*60);
		response.addCookie(cookieUserName);
	}
	
	//Tạo cookie
	//Lấy thông tin (UserName) từ Cookie đã lưu. Kiểm tra tên biến ATT_... còn được lưu trong cookie ko, nếu còn thì trả về cookie.getValue()
